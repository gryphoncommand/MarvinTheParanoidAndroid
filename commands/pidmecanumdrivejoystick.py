...
#         # self.pid["lf"] = PIDController(
#               pid.L[0], pid.L[1], pid.L[2], pid.L[3], src, drive.set_lf
#           )
...
#         self.applyPID(
#               lambda p: p.setPIDSourceType(PIDController.PIDSourceType.kRate)
#         )
...
#           "lf_pid_setpoint", self.pid["lf"].getSetpoint()
#         )
...
#     """
#         if (oi.joystick.getY() not in self.min_range)
#             and (oi.joystick.getX() in self.max_range):
